...
from imanage.common.exceptions import SendMailException
from imanage.common.models.mixins import ImanageModel
from imanage.common.urls import EventUrls
from imanage.mail.context import get_available_placeholders, get_mail_context
from imanage.mail.placeholders import SimpleFunctionalMailTextPlaceholder
from imanage.mail.signals import queuedmail_post_send, queuedmail_pre_send
...
class MailTemplate(ImanageModel):
    ...
    log_prefix = "imanage.mail_template"
    ...
    def to_mail(
        ...
        """Creates a :class:`~imanage.mail.models.QueuedMail` object from a
        MailTemplate.

        :param user: Either a :class:`~imanage.person.models.user.User` or an
    ...
    def valid_placeholders(self):
        ...
        if self.role == MailTemplateRoles.QUESTION_REMINDER:
            ...
            valid_placeholders["url"] = SimpleFunctionalMailTextPlaceholder(
                ...
                ["event", "user"],
                None,
                "https://imanage.example.com/democon/me/submissions/",
                is_visible=False,
            )
            kwargs = ["event", "user"]
            ...
            valid_placeholders["invitation_link"] = SimpleFunctionalMailTextPlaceholder(
                ...
                ["event", "user"],
                None,
                "https://imanage.example.com/democon/invitation/123abc/",
            )
            ...
            valid_placeholders["orga_url"] = SimpleFunctionalMailTextPlaceholder(
                ...
                ["event", "submission"],
                None,
                "https://imanage.example.com/orga/events/democon/submissions/124ABCD/",
            )
...
class QueuedMail(ImanageModel):
    """Emails in imanage are rarely sent directly, hence the name QueuedMail.
    ...
    def make_html(self):
        from imanage.common.templatetags.rich_text import render_markdown_abslinks
    ...
    def send(self, requestor=None, orga: bool = True):
        ...
        :type requestor: :class:`~imanage.person.models.user.User`

...
from imanage.agenda.rules import can_view_schedule, is_speaker_viewable
...
from imanage.person.rules import (
...
class SpeakerProfile(ImanageModel):
    """All :class:`~imanage.event.models.event.Event` related data concerning
    a.

    :class:`~imanage.person.models.user.User` is stored here.
    ...
    log_prefix = "imanage.user.profile"
    ...
    def submissions(self):
        ...
        :class:`~imanage.submission.models.submission.Submission` objects by
    ...
    def talks(self):
        ...
        :class:`~imanage.submission.models.submission.Submission` objects.
    ...
    @cached_property
    def answers(self):
        """A queryset of :class:`~imanage.submission.models.question.Answer`
        objects.

        Includes all answers the user has given either for themselves or
        for their talks for this event.
        """
        from imanage.submission.models import Answer, Submission

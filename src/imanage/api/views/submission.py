...
from imanage.api.filters.submission import SubmissionFilter
from imanage.api.serializers.legacy import (
...
from imanage.common.auth import TokenAuthentication
...
class SubmissionViewSet(ActivityLogMixin, ImanageViewSetMixin, viewsets.ModelViewSet):
...
class TagViewSet(ActivityLogMixin, ImanageViewSetMixin, viewsets.ModelViewSet):
...
class SubmissionTypeViewSet(
    ActivityLogMixin, ImanageViewSetMixin, viewsets.ModelViewSet
):
...
class TrackViewSet(ActivityLogMixin, ImanageViewSetMixin, viewsets.ModelViewSet):

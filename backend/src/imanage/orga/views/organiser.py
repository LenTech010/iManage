...
from imanage.event.forms import OrganiserForm, TeamForm, TeamInviteForm
from imanage.event.models import Event
from imanage.event.models.organiser import (
    Organiser,
    Team,
    TeamInvite,
    check_access_permissions,
)
from imanage.orga.tables.organiser import TeamTable
from imanage.orga.tables.speaker import SpeakerOrgaTable
from imanage.person.forms import UserSpeakerFilterForm
    ...
    def perform_delete(self):
        ...
        with transaction.atomic():
            self.object.log_action(
                "imanage.team.delete", person=self.request.user, orga=True
            )
...
class TeamUninvite(InviteMixin, ActionConfirmMixin, DetailView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        self.invite.delete()
        team.log_action(
            "imanage.team.invite.orga.retract",
...
class OrganiserDelete(PermissionRequired, ActionConfirmMixin, DetailView):
    ...
    def post(self, *args, **kwargs):
        ...
        return HttpResponseRedirect(reverse("orga:dashboard"))

...
from imanage.cfp.signals import footer_link, html_head
from imanage.common.models.settings import GlobalSettings
from imanage.common.text.phrases import phrases
from imanage.orga.utils.i18n import get_javascript_format, get_moment_locale
...
def system_information(request):
    ...
    if settings.DEBUG:
        ...
        context["imanage_version"] = settings.IMANAGE_VERSION

...
from imanage.common.db import Median
from imanage.common.forms.renderers import InlineFormRenderer
from imanage.common.text.phrases import phrases
from imanage.common.ui import Button, api_buttons
from imanage.common.views.generic import CreateOrUpdateView, OrgaTableMixin
from imanage.common.views.mixins import (
    ActionConfirmMixin,
    EventPermissionRequired,
    PermissionRequired,
)
from imanage.orga.forms.review import (
    BulkTagForm,
    DirectionForm,
...
from imanage.orga.forms.submission import SubmissionStateChangeForm
from imanage.orga.tables.submission import ReviewTable
from imanage.orga.views.submission import SubmissionListMixin
from imanage.person.models import User
from imanage.submission.forms import QuestionsForm, SubmissionFilterForm
...
class BulkTagging(EventPermissionRequired, SubmissionListMixin, TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        from imanage.common.views.generic import get_next_url
...
class ReviewSubmission(ReviewViewMixin, PermissionRequired, CreateOrUpdateView):
    ...
    extra_forms_signal = "imanage.orga.signals.review_form"
    ...
    def get_context_data(self, **kwargs):
        from imanage.submission.rules import filter_answers_by_team_access

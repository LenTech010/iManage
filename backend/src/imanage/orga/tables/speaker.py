...
from imanage.person.models import SpeakerInformation, SpeakerProfile


class SpeakerInformationTable(ImanageTable):
...
class SpeakerTable(QuestionColumnMixin, ImanageTable):
    default_columns = (
        "name",
        "submission_count",

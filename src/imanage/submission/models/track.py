...
class Track(OrderedModel, ImanageModel):
    """A track groups :class:`~imanage.submission.models.submission.Submission`
    objects within an :class:`~imanage.event.models.event.Event`, e.g. by
    topic.

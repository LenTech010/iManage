...
from imanage.cfp.flow import CfPFlow, cfp_field_labels
from imanage.common.forms import I18nFormSet
from imanage.common.text.phrases import phrases
from imanage.common.text.serialize import I18nStrJSONEncoder, serialize_i18n
from imanage.common.ui import send_button
from imanage.common.views.generic import OrgaCRUDView, get_next_url
...
from imanage.orga.forms import CfPForm, QuestionForm, SubmissionTypeForm, TrackForm
from imanage.orga.forms.cfp import (
    AccessCodeSendForm,
    AnswerOptionForm,
    CfPFieldConfigForm,
    CfPSettingsForm,
...
from imanage.orga.tables.cfp import (
    QuestionTable,
    SubmissionTypeTable,
    SubmitterAccessCodeTable,
    TrackTable,
)
from imanage.orga.utils.i18n import has_i18n_content
from imanage.person.forms import SpeakerProfileForm
from imanage.submission.forms import InfoForm, QuestionsForm
...
from imanage.submission.models.cfp import default_fields
from imanage.submission.rules import questions_for_user
    ...
    def form_valid(self, form):
        ...
        if form.has_changed():
            form.instance.log_action(
                "imanage.cfp.update", person=self.request.user, orga=True
            )
        self.sform.save()
        return result
...
class SubmissionTypeDefault(PermissionRequired, View):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        submission_type.log_action(
            "imanage.submission_type.make_default", person=self.request.user, orga=True
        )

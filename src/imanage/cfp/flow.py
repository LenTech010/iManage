...
from imanage.cfp.signals import cfp_steps
...
from imanage.person.forms import SpeakerProfileForm, UserForm
    ...
    def done(self, request, draft=False):
        ...
        if draft:
            ...
            form.instance.log_action(
                "imanage.submission.create", person=self.request.user
            )
        form.save()
        ...
        if draft:
            ...
            submission.log_action("imanage.submission.create", person=request.user)
            messages.success(
                self.request,
                _(

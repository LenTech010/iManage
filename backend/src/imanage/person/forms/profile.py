...
from imanage.cfp.forms.cfp import CfPFormMixin
from imanage.common.forms.fields import AvailabilitiesField, ImageField, SizeFileField
...
from imanage.submission.models import Question
...
class SpeakerInformationForm(ImanageI18nModelForm):

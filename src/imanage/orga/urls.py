...
urlpatterns = [
    ...
    path("reset/", RedirectView.as_view(url="/"), name="auth.reset"),
    path("reset/<token>", RedirectView.as_view(url="/"), name="auth.recover"),
    path("", RedirectView.as_view(url="/orga/dashboard/", permanent=False)),
    path("dashboard/", dashboard.start_redirect_view, name="dashboard"),

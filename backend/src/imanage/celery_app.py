...
from imanage.common.exceptions import ImanageCeleryExceptionReporter
...
def send_exception_email(
    ...
    if isinstance(exception, WorkerLostError):
        # We’re assuming that WorkerLostErrors are from restarting imanage
    ...
    reporter = ImanageCeleryExceptionReporter(
        request=None,

...
from imanage.cfp.forms.auth import ResetForm
from imanage.common.exceptions import SendMailException
from imanage.common.forms.mixins import ImanageI18nModelForm
from imanage.common.text.phrases import phrases
from imanage.common.ui import Button, back_button, delete_button
from imanage.common.views.helpers import get_htmx_target, is_htmx
from imanage.common.views.mixins import Filterable, PaginationMixin
...
class GenericResetView(FormView):
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, phrases.cfp.auth_password_reset)
        user.log_action("imanage.user.password.reset")
...
class CRUDView(PaginationMixin, FormLoggingMixin, Filterable, View):
    ...
    def get_form_kwargs(self):
        kwargs = {}
        event = getattr(self.request, "event", None)
        if event and issubclass(self.form_class, ImanageI18nModelForm):

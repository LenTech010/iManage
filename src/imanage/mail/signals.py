...
from imanage.common.signals import EventPluginSignal
...
an instance of a subclass of imanage.mail.placeholder.BaseMailTextPlaceholder or a list of these.
...
Receivers may raise a ``imanage.common.exceptions.SendMailException`` in order to stop
...
draft reminders, or anything else that imanage thinks should be private

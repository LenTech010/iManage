...
from imanage.common.forms.tables import TablePreferencesForm
...
class ImanageTable(tables.Table):
...
class FunctionOrderMixin:
    ...
    used by ImanageTable._apply_ordering() to handle multi-column sorting correctly.
    ...
    ImanageTable._apply_ordering() is used instead, which properly handles all columns
    ...
    def apply_function_ordering(self, queryset, descending):
        ...
        - ImanageTable._apply_ordering() for multi-column sorting
    ...
    def order(self, queryset, is_descending):
        ...
        for single-column ordering scenarios. For multi-column sorting in ImanageTable,
...
class QuestionColumn(TemplateColumn):
    ...
    def apply_custom_ordering(self, queryset, is_descending):
        ...
        Used by ImanageTable._apply_ordering() for multi-column sorting.

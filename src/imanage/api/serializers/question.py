...
class AnswerOptionSerializer(FlexFieldsSerializerMixin, ImanageSerializer):
    ...
    class Meta:
        ...
        expandable_fields = {
            "question": (
                "imanage.api.serializers.question.QuestionSerializer",
...
@register_serializer(versions=CURRENT_VERSIONS)
class QuestionSerializer(FlexFieldsSerializerMixin, ImanageSerializer):
    identifier = CharField(required=False, allow_blank=True)
    ...
    class Meta:
        ...
        expandable_fields = {
            ...
            "options": (
                "imanage.api.serializers.question.AnswerOptionSerializer",
                {
                    "many": True,
                    "read_only": True,
...
@register_serializer(versions=CURRENT_VERSIONS)
class AnswerSerializer(FlexFieldsSerializerMixin, ImanageSerializer):
    question = PrimaryKeyRelatedField(read_only=True)

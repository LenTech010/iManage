...
from imanage.common.update_check import check_result_table, update_check
from imanage.common.views.generic import OrgaCRUDView
from imanage.common.views.mixins import PermissionRequired
from imanage.orga.forms.admin import UpdateSettingsForm
from imanage.orga.tables.admin import AdminUserTable
...
class AdminDashboard(PermissionRequired, TemplateView):
    ...
    @context
    def imanage_version(self):
        return settings.IMANAGE_VERSION
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            mail_send_task.apply(
                kwargs={
                    "to": admin_emails,
                    "subject": _("imanage test email"),
                    "body": _(
                        "This is a test email from imanage to verify your system email configuration is working correctly."
                    ),
                    "html": None,
                }
            )

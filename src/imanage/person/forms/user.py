...
from imanage.common.forms.fields import NewPasswordConfirmationField, NewPasswordField
from imanage.common.forms.renderers import InlineFormLabelRenderer
from imanage.common.forms.widgets import PasswordInput
...
class UserForm(CfPFormMixin, forms.Form):
    ...
    def ratelimit_key(self):
        ...
        if ip_address.is_private:
            ...
            return None
        return f"imanage_login_{ip_address}"

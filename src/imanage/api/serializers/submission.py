...
@register_serializer()
class ResourceSerializer(FlexFieldsSerializerMixin, ImanageSerializer):
...
class TagSerializer(ImanageSerializer):
    class Meta:
        model = Tag
...
@register_serializer(versions=CURRENT_VERSIONS)
class SubmissionTypeSerializer(ImanageSerializer):
    class Meta:
...
@register_serializer(versions=CURRENT_VERSIONS)
class TrackSerializer(ImanageSerializer):
    class Meta:
        model = Track
        fields = (
            "id",
...
@register_serializer(versions=CURRENT_VERSIONS)
class SubmissionInvitationSerializer(FlexFieldsSerializerMixin, ImanageSerializer):
    class Meta:
...
@register_serializer(versions=CURRENT_VERSIONS)
class SubmissionSerializer(FlexFieldsSerializerMixin, ImanageSerializer):
    ...
    class Meta:
        ...
        expandable_fields = {
            ...
            "tags": (
                "imanage.api.serializers.submission.TagSerializer",
        ...
        extra_expandable_fields = {
            ...
            "answers": (
                "imanage.api.serializers.question.AnswerSerializer",
                {"many": True, "read_only": True},
            ),
            "speakers": (
                "imanage.api.serializers.speaker.SpeakerSerializer",
                {"many": True, "read_only": True},
            ),
            "resources": (
                "imanage.api.serializers.submission.ResourceSerializer",
                {"many": True, "read_only": True},
            ),
        }
...
class SubmissionOrgaSerializer(SubmissionSerializer):
    ...
    class Meta(SubmissionSerializer.Meta):
        ...
        extra_expandable_fields = SubmissionSerializer.Meta.extra_expandable_fields | {
            "speakers": (
                "imanage.api.serializers.speaker.SpeakerOrgaSerializer",
                {"many": True, "read_only": True},
            ),
            "invitations": (
                "imanage.api.serializers.submission.SubmissionInvitationSerializer",
                {"many": True, "read_only": True},
            ),
        }

...
from imanage.agenda.rules import is_agenda_submission_visible
...
from imanage.common.ui import Button, back_button
...
from imanage.orga.forms.submission import (
    AddSpeakerForm,
...
from imanage.orga.tables.submission import SubmissionTable, TagTable
from imanage.person.models import User
from imanage.person.rules import is_only_reviewer
from imanage.submission.forms import (
    QuestionsForm,
    ResourceForm,
...
class SubmissionContent(
    ...
    extra_forms_signal = "imanage.orga.signals.submission_form"
...
class CommentDelete(SubmissionViewMixin, ActionConfirmMixin, TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        comment.submission.log_action(
            "imanage.submission.comment.delete", person=request.user, orga=True
        )
        comment.delete()

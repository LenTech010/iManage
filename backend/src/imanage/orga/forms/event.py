...
from imanage.common.forms.fields import ColorField, ImageField
from imanage.common.forms.mixins import (
    HierarkeyMixin,
    JsonSubfieldMixin,
    ImanageI18nFormMixin,
    ImanageI18nModelForm,
    ReadOnlyFlag,
)
from imanage.common.forms.renderers import InlineFormLabelRenderer, InlineFormRenderer
from imanage.common.forms.widgets import (
    EnhancedSelect,
...
from imanage.common.text.css import validate_css
from imanage.common.text.phrases import phrases
from imanage.event.models.event import Event, EventExtraLink
from imanage.orga.forms.widgets import HeaderSelect, MultipleLanguagesWidget
from imanage.schedule.models import Availability, Room, TalkSlot
from imanage.submission.models import ReviewPhase, ReviewScore, ReviewScoreCategory
...
class EventForm(ReadOnlyFlag, JsonSubfieldMixin, ImanageI18nModelForm):
    locales = forms.MultipleChoiceField(
        label=_("Active languages"),
        choices=[],
        widget=MultipleLanguagesWidget,
        help_text=_(
            "Users will be able to use imanage in these languages, and you will be able to provide all texts in these"
...
class MailSettingsForm(
    ReadOnlyFlag, ImanageI18nFormMixin, JsonSubfieldMixin, forms.Form
):
...
class WidgetSettingsForm(JsonSubfieldMixin, forms.Form):
    show_widget_if_not_public = forms.BooleanField(
        ...
        help_text=_(
            "Set to allow external pages to show the schedule widget, even if the schedule is not shown here using imanage."
        ),
        required=False,
    )
...
class ReviewPhaseForm(ImanageI18nModelForm):
...
class ReviewScoreCategoryForm(ImanageI18nModelForm):
...
class EventExtraLinkForm(ImanageI18nModelForm):
...
class EventHistoryFilterForm(forms.Form):
    ...
    ACTION_TYPE_GROUPS = {
        _("Proposals"): [
            ("imanage.submission.create", _("Created")),
            ("imanage.submission.update", _("Modified")),
            ("imanage.submission.delete", _("Deleted")),
            ("imanage.submission.deleted", _("Deleted")),
            ("imanage.submission.accept", _("Accepted")),
            ("imanage.submission.reject", _("Rejected")),
            ("imanage.submission.cancel", _("Cancelled")),
            ("imanage.submission.confirm", _("Confirmed")),
            ("imanage.submission.withdraw", _("Withdrawn")),
        ],
        _("Custom fields"): [
            ("imanage.question.create", _("Created")),
            ("imanage.question.update", _("Modified")),
            ("imanage.question.delete", _("Deleted")),
            ("imanage.question.option.create", _("Option created")),
            ("imanage.question.option.update", _("Option modified")),
            ("imanage.question.option.delete", _("Option deleted")),
        ],
        _("Emails"): [
            ("imanage.mail.create", _("Created")),
            ("imanage.mail.update", _("Modified")),
            ("imanage.mail.delete", _("Deleted")),
            ("imanage.mail.sent", _("Sent")),
            ("imanage.mail_template.create", _("Template created")),
            ("imanage.mail_template.update", _("Template modified")),
            ("imanage.mail_template.delete", _("Template deleted")),
        ],
        _("Schedule"): [
            ("imanage.schedule.release", _("Released")),
            ("imanage.room.create", _("Room created")),
            ("imanage.room.update", _("Room modified")),
            ("imanage.room.delete", _("Room deleted")),
        ],
        _("Event"): [
            ("imanage.event.create", _("Created")),
            ("imanage.event.update", _("Modified")),
            ("imanage.event.activate", _("Activated")),
            ("imanage.event.deactivate", _("Deactivated")),
            ("imanage.cfp.update", _("CfP modified")),
        ],
    }
        ...
        if event:
            ...
            for action_type in action_types:
                if action_type not in seen_actions:
                    ...
                    display_name = (
                        action_type.replace("imanage.", "").replace(".", " ").title()
                    )

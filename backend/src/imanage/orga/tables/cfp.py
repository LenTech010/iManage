...
class SubmitterAccessCodeTable(ImanageTable):
    default_columns = (
        "code",
        "track",
        "submission_type",
...
class TrackTable(UnsortableMixin, ImanageTable):
    default_columns = (
        "name",
        "color",
        "proposals",
...
class SubmissionTypeTable(ImanageTable):
    default_columns = (
        "name",
        "proposals",
        "default_duration",
...
class QuestionTable(UnsortableMixin, ImanageTable):
    default_columns = (
        "question",
        "target",
        "variant",

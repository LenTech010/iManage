...
from imanage.common.models.fields import DateTimeField, MarkdownField
from imanage.common.models.mixins import OrderedModel, ImanageModel
from imanage.common.urls import EventUrls
from imanage.person.rules import is_administrator, is_reviewer
...
class ReviewScoreCategory(ImanageModel):
...
class ReviewScore(ImanageModel):
...
class Review(ImanageModel):
    ...
    text = MarkdownField(verbose_name=_("Comments for authors"), null=True, blank=True)
    internal_text = MarkdownField(
        verbose_name=_("Confidential comments for admin"), null=True, blank=True
    )
    ...
    log_prefix = "imanage.submission.review"
...
class ReviewPhase(OrderedModel, ImanageModel):

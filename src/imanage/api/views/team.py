...
from imanage.api.serializers.team import TeamInviteSerializer, TeamSerializer
from imanage.api.views.mixins import ImanageViewSetMixin
from imanage.event.models import Team, TeamInvite
from imanage.event.models.organiser import check_access_permissions
...
class TeamViewSet(ImanageViewSetMixin, viewsets.ModelViewSet):

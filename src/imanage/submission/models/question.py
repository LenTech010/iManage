...
from imanage.common.models.fields import DateField, DateTimeField
from imanage.common.models.mixins import GenerateCode, OrderedModel, ImanageModel
...
class Question(GenerateCode, OrderedModel, ImanageModel):
    """Questions can be asked per.

    :class:`~imanage.submission.models.submission.Submission`, per speaker, or
    of reviewers per :class:`~imanage.submission.models.review.Review`.
...
class AnswerOption(GenerateCode, ImanageModel):
    """Provides the possible answers for.

    :class:`~imanage.submission.models.question.Question` objects of variant
    ...
    log_prefix = "imanage.question.option"
...
class Answer(ImanageModel):
    """Answers are connected to a.

    :class:`~imanage.submission.models.question.Question`, and, depending on
    type, a :class:`~imanage.person.models.user.User`, a
    :class:`~imanage.submission.models.submission.Submission`, or a
    :class:`~imanage.submission.models.review.Review`.
    """

    log_prefix = "imanage.submission.answer"

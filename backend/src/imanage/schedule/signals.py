...
from imanage.common.signals import EventPluginSignal, register_data_exporters
...
def register_ical_exporter(sender, **kwargs):
    from imanage.schedule.exporters import ICalExporter
...
def register_faved_ical_exporter(sender, **kwargs):
    from imanage.schedule.exporters import FavedICalExporter
...
def register_xml_exporter(sender, **kwargs):
    from imanage.schedule.exporters import FrabXmlExporter
...
def register_xcal_exporter(sender, **kwargs):
    from imanage.schedule.exporters import FrabXCalExporter
...
def register_json_exporter(sender, **kwargs):
    from imanage.schedule.exporters import FrabJsonExporter

...
from imanage.agenda.rules import is_agenda_submission_visible, is_agenda_visible
...
from imanage.common.urls import get_netloc
from imanage.schedule.ical import get_slot_ical, patch_out_timezone_cache
from imanage.submission.rules import is_break, is_wip, orga_can_change_submissions
...
class TalkSlot(ImanageModel):
    """The TalkSlot object is the scheduled version of a.

    :class:`~imanage.submission.models.submission.Submission`.

    TalkSlots always belong to one submission and one :class:`~imanage.schedule.models.schedule.Schedule`.
    ...
    def as_availability(self):
        ...
        :class:`~imanage.schedule.models.availability.Availability`, useful for
    ...
    def copy_to_schedule(self, new_schedule, save=True):
        ...
        :class:`~imanage.schedule.models.schedule.Schedule` with all other
    ...
    def build_ical(self, calendar, creation_time=None, netloc=None):
        ...
        with patch_out_timezone_cache(self.event.tz):
            ...
            vevent.add("uid").value = "imanage-{}-{}{}@{}".format(

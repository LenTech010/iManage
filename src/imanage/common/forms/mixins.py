...
from imanage.common.forms.fields import ExtensionFileField
from imanage.common.forms.validators import (
...
class QuestionFieldsMixin:
    ...
    def save_questions(self, key, value):
        ...
        from imanage.submission.models import Answer, QuestionTarget
...
class ImanageI18nFormMixin(I18nFormMixin):
...
class ImanageI18nModelForm(ImanageI18nFormMixin, I18nModelForm):
    pass

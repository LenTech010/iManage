...
from imanage.agenda.rules import is_widget_visible
from imanage.common.views.cache import conditional_cache_page

WIDGET_JS_CHECKSUM = None
WIDGET_PATH = "agenda/js/imanage-schedule.min.js"

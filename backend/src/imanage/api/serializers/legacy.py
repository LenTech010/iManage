...
from imanage.api.serializers.room import AvailabilitySerializer
from imanage.api.serializers.submission import ResourceSerializer
from imanage.api.versions import LEGACY, register_serializer
from imanage.person.models import SpeakerProfile, User
from imanage.schedule.models import Availability, Room, Schedule, TalkSlot
...
class LegacyTagSerializer(ImanageSerializer):
    class Meta:
        model = Tag
...
class LegacyRoomSerializer(ImanageSerializer):

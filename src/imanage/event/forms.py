...
class TeamForm(ReadOnlyFlag, ImanageI18nModelForm):
    @scopes_disabled()
...
class OrganiserForm(ReadOnlyFlag, ImanageI18nModelForm):
...
class EventWizardBasicsForm(ImanageI18nModelForm):
...
class EventWizardPluginForm(forms.Form):
    def __init__(
        ...
        **kwargs,
        ...
        from imanage.orga.forms.widgets import PluginSelectWidget

...
from imanage.agenda.views.utils import get_schedule_exporter_content
...
from imanage.api.filters.schedule import TalkSlotFilter
from imanage.api.serializers.legacy import LegacyScheduleSerializer
from imanage.api.serializers.schedule import (
...
class ScheduleViewSet(ImanageViewSetMixin, viewsets.ReadOnlyModelViewSet):

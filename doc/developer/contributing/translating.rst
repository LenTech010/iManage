...
imanage has been translated to other languages, and what’s more – you can use
imanage in several languages for your event, which helps you to be accessible
to a diverse range of people. To make this work, the imanage interfaces need to
be translated, too.
...
You can do this on our translation platform at `translate.imanage.com`_.

Official and unofficial languages
---------------------------------

Translations of imanage are divided into official and unofficial languages.

Official languages
    are translated and maintained by the core team behind imanage or as part of long-term partnerships. We are
    committed to keeping these translations up-to-date with new features or changes in imanage and try to offer
...
Unofficial languages
    are contributed and maintained by the community. We ship them with imanage so you can use them, but we cannot
    guarantee that new or changed features in imanage will be translated in time for a new release. Since we
...
a note of how many percent of imanage they cover. You can see the current
status that will be included in the next release here:

.. image:: https://translate.imanage.com/widget/imanage/imanage/multi-auto.svg
   :target: https://translate.imanage.com/engage/imanage/
   :align: center

New languages will be included in the next release if they cover at least 75%
of imanage, though we won’t immediately remove languages that fall below this
threshold.

Translating imanage
-------------------

If you visit `translate.imanage.com`_ for the first time, it will look a bit bare.
...
the imanage project dashboard. You can add new translations by clicking on
...
New or changed translations are not visible in imanage immediately. We update
the translations in the development version of imanage regularly (roughly
weekly), and also before every new release.

If you want to see your translations in imanage, you can either wait for the
next release, or you can :ref:`install the development version<installing-a-commit>`
of imanage in production, or set up a :ref:`local development environment<devsetup>`.

.. _translate.imanage.com: https://translate.imanage.com

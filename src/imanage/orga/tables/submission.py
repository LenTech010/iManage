...
from imanage.orga.utils.i18n import Translate
from imanage.submission.models import Review, Submission, Tag


class SubmissionTable(QuestionColumnMixin, ImanageTable):
...
class ReviewTable(QuestionColumnMixin, ImanageTable):

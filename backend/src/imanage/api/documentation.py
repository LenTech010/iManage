...
if not settings.LOAD_SPECTACULAR or not SPECTACULAR_LOADED:
    from imanage.api.shims import (  # noqa
        OpenApiExample,
        OpenApiParameter,
        OpenApiResponse,
        OpenApiTypes,
...
def build_expand_docs(*params):
    description = 'Select fields to <a href="https://docs.imanage.org/api/fundamentals/#expanding-linked-resources">expand</a>.'
...
def postprocess_schema(result, generator, request, public):
    ...
    result["tags"] = [
        ...
        },
        {
            "name": "submissions",
            "description": (
                "Submissions are the central component of imanage. "
            ...
            "externalDocs": {
                "url": "https://docs.imanage.org/user/sessions/",
        ...
        },
        {
            "name": "schedules",
            "description": (
                "In imanage, an event’s schedule is versioned, and each version is a schedule object in the API. "
                ...
                "As retrieving the fully expanded endpoint is expensive on the imanage side, "
        ...
        },
        {
            "name": "slots",
            "description": (
                "Every block in a published imanage schedule is a talk slot. Note that there are talk slots without associated submission (e.g. breaks). "
        ...
        },
        {
            ...
            "externalDocs": {
                "url": "https://docs.imanage.org/user/sessions/#session-types",
                "description": "User documentation",
            },
        },
        {
            ...
            "externalDocs": {
                "url": "https://docs.imanage.org/user/sessions/#tags",
                "description": "User documentation",
            },
        },
        {
            ...
            "externalDocs": {
                "url": "https://docs.imanage.org/user/sessions/#tracks",
                "description": "User documentation",
            },
        },
        {
        ...
        {
            "name": "file-uploads",
            "description": "Upload files for further use in other resources of the imanage API.",
            "externalDocs": {
                "url": "https://docs.imanage.org/api/fundamentals/#file-uploads",

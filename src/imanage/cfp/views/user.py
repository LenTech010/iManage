...
from imanage.cfp.forms.submissions import SubmissionInvitationForm
from imanage.cfp.views.event import LoggedInEventPageMixin
from imanage.common.forms.fields import SizeFileInput
from imanage.common.image import gravatar_csp
from imanage.common.middleware.event import get_login_redirect
from imanage.common.text.phrases import phrases
from imanage.common.text.serialize import json_roundtrip
from imanage.common.ui import Button, LinkButton, back_button, delete_button
from imanage.common.views.helpers import is_form_bound
...
from imanage.submission.forms import InfoForm, QuestionsForm, ResourceForm
...
class ProfileView(LoggedInEventPageMixin, TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        if self.login_form.is_bound and self.login_form.is_valid():
            ...
            request.user.log_action("imanage.user.password.update")
...
class SubmissionInviteView(LoggedInEventPageMixin, SubmissionViewMixin, FormView):
    ...
    def form_valid(self, form):
        ...
        self.submission.log_action(
            "imanage.submission.invitation.send",
            person=self.request.user,
...
class SubmissionInviteAcceptView(LoggedInEventPageMixin, DetailView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        submission.log_action(
            "imanage.submission.invitation.accept",
            person=self.request.user,
            data={"email": email},
        )
